...
namespace NitroSystem.Dnn.BusinessEngine.Abstractions.Data.Contracts
{
    public interface IRepositoryBase
    {
        ...
        Task<IEnumerable<TColumnType>> GetColumnsValueAsync<T, TColumnType>(string column, string filerColumn, object filterValue) where T : class, IEntity, new();
        ...
        Task<IEnumerable<TChild>> GetChildsByParentColumn<TParent, TChild>(string parentColumn,string childColumn, object value)
        ...
        Task<Guid> AddAsync<T>(T entity) where T : class, IEntity, new();
        ...
        Task<(IEnumerable<T1>, IEnumerable<T2>, IEnumerable<T3>, IEnumerable<T4>, IEnumerable<T5>)> ExecuteStoredProcedureMultipleAsync<T1, T2, T3, T4, T5>(
           string storedProcedure,
           string cacheKey,
           object parameters = null);
    }
