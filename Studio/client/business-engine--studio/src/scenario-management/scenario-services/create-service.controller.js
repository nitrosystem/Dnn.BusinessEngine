...
export class CreateServiceController {
    ...
    onPageLoad() {
        ...
        this.apiService.get("Studio", "GetService", { serviceId: id || null }).then((data) => {
        ...
        if (!this.isServiceLoaded) {
            ...
            this.apiService
                .get("Studio", "GetServiceDependencies", {
                    ...
                    $("#pnlServiceBuilder" + (this.service.Id ? this.service.Id : "")).html(this.$compile(serviceComponent)(this.$scope));
                    ...
                    if (isValid) {
                        ...
                        this.apiService.post("Studio", "SaveService", this.service).then((data) => {
                            ...
                            this.submitApi().then(() => {
                                ...
                                if (this.isNewService) delete this.service.Id;
