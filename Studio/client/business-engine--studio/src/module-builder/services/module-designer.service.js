...
<div b-field="${field.Id}" class="b-field-wrapper">
    ...
    <div data-field="${field.Id}" class="b-field-item" 
        ...
        <div class="field-toolbar" ng-if="$.currentField.Id=='${field.Id}'"
            ng-click="$.onFieldToolbarClick($event)">
            <div class="progress opacity-100" ng-if="$.running=='refresh-field' || $.running=='save-field'"
                role="progressbar" aria-label="{{$.awaitAction.subtitle}}" aria-valuenow="0" aria-valuemin="0"
                aria-valuemax="100">
                <p class="await-action-subtitle position-absolute w-100 text-center p-3 lh-1">
                    ({{$.awaitAction.subtitle}})</p>
            ...
            <div class="row mb-3" ng-if="!$.field.${field.FieldName}.FieldTypeObject.IsContent">
                <div class="col-6">
                    <div class="field-title-wrapper">
                        ...
                        <b ng-class="{'opacity-25':$.field.${field.FieldName}.Settings.IsHideFieldText}">Field
                            Text(Label):</b>
        ...
        <p class="text-warning mt-2 mb-0" ng-show="$.currentField.Id!=='${field.Id}' && $.fieldsUnsaved['${field.Id}'].length">
            This field has been edited but not saved. This may cause problems...!
            <b class="d-block" ng-repeat="prop in $.fieldsUnsaved['${field.Id}'] track by $index">{{prop}}</b>
        </p>
    </div>
