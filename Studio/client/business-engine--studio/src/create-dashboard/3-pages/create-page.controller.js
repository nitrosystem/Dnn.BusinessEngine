export class CreateDashboardPageController {
    ...
    onPageLoad() {
        ...
        this.apiService.get("Module", "GetDashboardPage", { moduleId: moduleId, pageId: pageId, }).then((data) => {
    ...
    setForm() {
        this.form = this.validationService.init({
            ...
            "Module.ModuleName": {
                id: "txtModuleName",
                rule: (value) => {
                    if (this.page.PageType === 0 && /^[A-Z][A-Za-z0-9]*$/.test(value) == false)
                        return "Page name is not valid";
                    else
                        return true;
                },
