...
using NitroSystem.Dnn.BusinessEngine.BusinessLogic.Enums;
using NitroSystem.Dnn.BusinessEngine.BusinessLogic.Models;
...
{
    public static class ModuleFieldMappings
    {
        private const string FieldCachePrefix = "BE_ModuleFields_";

        #region Field Type Mapping

        public static IEnumerable<ModuleFieldTypeViewModel> GetFieldTypesViewModel()
        {
        ...
        public static IEnumerable<ModuleFieldTypeViewModel> GetFieldTypesViewModel(IEnumerable<ModuleFieldTypeView> fieldTypes)
        {
            ...
            {
                var fieldType = GetFieldTypeViewModel(objFieldTypeView);
        ...
        public static ModuleFieldTypeViewModel GetFieldTypeViewModel(ModuleFieldTypeView objFieldTypeView)
        {
        ...
        public static IEnumerable<ModuleFieldViewModel> GetFieldsViewModel(Guid scenarioID)
        {
            var fields = ModuleFieldRepository.Instance.GetScenarioFields(scenarioID);

            return GetFieldsViewModel(fields);
        }

        public static IEnumerable<ModuleFieldViewModel> GetFieldsViewModel(IEnumerable<ModuleFieldInfo> fields)
        {
            return GetFieldsViewModel(fields, null, null, null, false);
        }

        public static IEnumerable<ModuleFieldViewModel> GetFieldsViewModel(Guid moduleID, IServiceWorker serviceWorker = null, IModuleData moduleData = null, UserInfo userInfo = null)
        {
        ...
        public static ModuleFieldViewModel GetFieldViewModel(Guid fieldID, IServiceWorker serviceWorker = null, IModuleData moduleData = null, UserInfo userInfo = null)
        {
        ...
        public static IEnumerable<ModuleFieldViewModel> GetFieldsViewModel(IEnumerable<ModuleFieldInfo> fields, IServiceWorker serviceWorker = null, IModuleData moduleData = null, UserInfo userInfo = null, bool includeActions = true)
        {
        ...
        public static ModuleFieldViewModel GetFieldViewModel(ModuleFieldInfo objModuleFieldInfo, IServiceWorker serviceWorker = null, IModuleData moduleData = null, bool includeActions = true)
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                .ForMember(dest => dest.Actions, map => { map.PreCondition(source => source.FieldID != null && includeActions); map.MapFrom(source => ActionMapping.GetActionsViewModel(source.ModuleID, source.FieldID)); });
            });
        ...
        #region Field Data Source Mapping

        public static FieldDataSourceResult GetFieldDataSource(string dataSourceSettings, IServiceWorker serviceWorker, bool isServerSide = true)
        {
        ...
        public static FieldDataSourceResult GetFieldDataSourceItems(FieldDataSourceInfo dataSource, IServiceWorker serviceWorker, bool isServerSide)
        {
        ...
        public static IEnumerable<FieldDTO> GetFieldsDTO(Guid moduleID, UserInfo userInfo = null)
        {
        ...
        public static IEnumerable<FieldDTO> GetFieldsDTO(IEnumerable<ModuleFieldInfo> fields, UserInfo userInfo = null)
        {
        ...
        public static FieldDTO GetFieldDTO(ModuleFieldInfo objModuleFieldInfo)
        {
            var config = new MapperConfiguration(cfg =>
            {
