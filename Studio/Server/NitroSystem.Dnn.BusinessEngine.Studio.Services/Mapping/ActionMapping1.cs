...
namespace NitroSystem.Dnn.BusinessEngine.BusinessLogic.Mapping
{
    public static class ActionMapping
    {
        ...
        public static IEnumerable<ActionTypeViewModel> GetActionTypesViewModel(IEnumerable<ActionTypeView> actionTypes)
        {
        ...
        public static IEnumerable<ActionViewModel> GetActionsViewModel(Guid scenarioID)
        {
            var actions = ActionRepository.Instance.GetScenarioActions(scenarioID);
        ...
        public static IEnumerable<ActionViewModel> GetFieldActionsViewModel(Guid fieldID)
        {
        ...
        public static IEnumerable<ActionViewModel> GetActionsViewModel(IEnumerable<ActionInfo> actions)
        {
        ...
        public static IEnumerable<ActionResultViewModel> GetActionResulstViewModel(Guid actionID)
        {
        ...
        public static ActionResultViewModel GetActionResultViewModel(ActionResultInfo objActionResultInfo)
        {
            var config = new MapperConfiguration(cfg =>
            {
        ...
        public static IEnumerable<ActionDto> GetActionsDTO(Guid moduleID)
        {
