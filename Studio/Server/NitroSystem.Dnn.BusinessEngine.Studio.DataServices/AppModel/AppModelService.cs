...
namespace NitroSystem.Dnn.BusinessEngine.Studio.DataServices.AppModel
{
    public class AppModelService : IAppModelService
    {
        ...
        public async Task<Guid> SaveAppModelAsync(AppModelViewModel appModel, bool isNew, string basePath)
        {
            ...
            try
            {
                ...
                var outputPath = $@"{basePath}\business-engine\{scenarioName}\AppModelTypes";
                ...
                objAppModelInfo.TypeRelativePath = $"{basePath}/business-engine/{scenarioName}/AppModelTypes/";
