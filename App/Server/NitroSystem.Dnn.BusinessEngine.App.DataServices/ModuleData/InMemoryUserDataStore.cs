...
namespace NitroSystem.Dnn.BusinessEngine.App.DataServices.ModuleData
{
    public class InMemoryUserDataStore : IUserDataStore
    {
        ...
        public async Task<ConcurrentDictionary<string, object>> GetOrCreateModuleDataAsync(string connectionId, Guid moduleId)
        {
            ...
            try
            {
                ...
                var clonedData = await GetClonedModuleData(moduleId);
        ...
        private async Task<ConcurrentDictionary<string, object>> GetClonedModuleData(Guid moduleId)
        {
        ...
        public async Task<ConcurrentDictionary<string, object>> UpdateModuleData(string connectionId, Guid moduleId, Dictionary<string, object> incomingData)
        {
            var portalSettings = PortalSettings.Current;
