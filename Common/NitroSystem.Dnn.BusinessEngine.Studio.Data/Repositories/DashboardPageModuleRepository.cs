...
namespace NitroSystem.Dnn.BusinessEngine.Data.Repositories
{
    public class DashboardPageModuleRepository
    {
        ...
        public IEnumerable<DashboardPageModuleView> GetModulesByParentID(Guid moduleID)
        {
            using (IDataContext ctx = DataContext.Instance())
            {
                var rep = ctx.GetRepository<DashboardPageModuleView>();
        ...
        public IEnumerable<DashboardPageModuleInfo> GetScenarioModules(Guid scenarioID)
        {
            using (IDataContext ctx = DataContext.Instance())
            {
                var rep = ctx.GetRepository<DashboardPageModuleInfo>();
