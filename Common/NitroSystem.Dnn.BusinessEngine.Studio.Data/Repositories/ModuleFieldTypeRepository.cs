...
namespace NitroSystem.Dnn.BusinessEngine.Data.Repositories
{
    public class ModuleFieldTypeRepository
    {
        ...
        public string GetFieldTypeIcon(string fieldType)
        {
            using (IDataContext ctx = DataContext.Instance())
            {
                return ctx.ExecuteScalar<string>(System.Data.CommandType.Text, "Select Icon From dbo.BusinessEngine_ModuleFieldTypes Where FieldType = @0", fieldType) ?? string.Empty;
            }
        }
